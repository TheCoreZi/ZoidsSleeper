...
export const ZOID_LIST: Record<string, ZoidSpecies> = {
  ...
  crosswinger: { id: 'crosswinger', name: 'Crosswinger', attack: 70, maxHealth: 100, baseExp: 30, scanRate: 70, price: 5000, faction: Faction.HelicRepublic, levelType: LevelType.Fast, terrainTypes: [TerrainType.Air], coreFragments: 800, size: ZoidSize.XS },
  ...
  goliath: { id: 'goliath', name: 'Goliath', attack: 10, maxHealth: 450, baseExp: 60, scanRate: 80, price: 6000, faction: Faction.GuylosEmpire, levelType: LevelType.MediumFast, terrainTypes: [TerrainType.Land], coreFragments: 1000, size: ZoidSize.XS },
  ...
  grandmolar: { id: 'grandmolar', name: 'Grandmolar', attack: 120, maxHealth: 400, baseExp: 50, scanRate: 40, price: 20000, faction: Faction.GuylosEmpire, levelType: LevelType.MediumSlow, terrainTypes: [TerrainType.Land], coreFragments: 1000, size: ZoidSize.XS },
  ...
  saradin: { id: 'saradin', name: 'Saradin', attack: 60, maxHealth: 500, baseExp: 50, scanRate: 60, price: 10000, faction: Faction.HelicRepublic, levelType: LevelType.MediumSlow, terrainTypes: [TerrainType.Land], coreFragments: 1000, size: ZoidSize.XS },
