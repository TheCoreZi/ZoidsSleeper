...
export const ZOID_LIST: Record<string, ZoidSpecies> = {
  ...
  aquadon: { id: 'aquadon', name: 'Aquadon', attack: 100, maxHealth: 80, baseExp: 50, scanRate: 65, price: 2000, faction: Faction.HelicRepublic, levelType: LevelType.Fast, terrainTypes: [TerrainType.Water], coreFragments: 400, size: ZoidSize.S, height: 2.7, length: 9.8, speed: 80, type: 'frog', weight: 5.9, width: 6 },
  ...
  elephantus: { id: 'elephantus', name: 'Elephantus', attack: 100, maxHealth: 200, baseExp: 80, scanRate: 30, price: 20000, faction: Faction.HelicRepublic, levelType: LevelType.MediumSlow, terrainTypes: [TerrainType.Land], coreFragments: 2000, size: ZoidSize.M, height: 4, length: 8.3, speed: 95, type: 'elephant', weight: 17.7, width: 5.1 },
  garius: { id: 'garius', name: 'Garius', attack: 50, maxHealth: 100, baseExp: 50, scanRate: 40, price: 4000, faction: Faction.HelicRepublic, levelType: LevelType.Fast, terrainTypes: [TerrainType.Land], coreFragments: 1000, size: ZoidSize.S, height: 7.8, length: 6.5, speed: 270, type: 'dinosaur', weight: 12.5, width: 3.5 },
  ...
  glidoler: { id: 'glidoler', name: 'Glidoler', attack: 100, maxHealth: 40, baseExp: 50, scanRate: 40, price: 4000, faction: Faction.HelicRepublic, levelType: LevelType.MediumFast, terrainTypes: [TerrainType.Air, TerrainType.Land, TerrainType.Water], coreFragments: 1000, size: ZoidSize.S, height: 5.2, length: 5.3, speed: 5186, type: 'waterfowl', weight: 3.9, width: 6.2 },
  ...
  gorgodos: { id: 'gorgodos', name: 'Gorgodos', attack: 140, maxHealth: 400, baseExp: 50, scanRate: 35, price: 12000, faction: Faction.HelicRepublic, levelType: LevelType.Slow, terrainTypes: [TerrainType.Land], coreFragments: 1200, size: ZoidSize.M, height: 5.2, length: 12.2, speed: 105, type: 'dinosaur', weight: 13.3, width: 4.4 },
  ...
  gurantula: { id: 'gurantula', name: 'Gurantula', attack: 120, maxHealth: 300, baseExp: 35, scanRate: -1, price: 4000, faction: Faction.HelicRepublic, levelType: LevelType.Fast, terrainTypes: [TerrainType.Land], coreFragments: 800, size: ZoidSize.XS, height: 4.8, length: 6, speed: 330, type: 'spider', weight: 4.6, width: 6 },
