...
import { AttackEvolution, HealthEvolution, LevelEvolution } from '../evolution';
...
export const ZOID_LIST: Record<string, ZoidSpecies> = {
  ...
  crablaster: { id: 'crablaster', name: 'Crablaster', attack: 50, maxHealth: 140, baseExp: 20, scanRate: 75, price: 2500, faction: Faction.ZenebasEmpire, levelType: LevelType.Fast, terrainTypes: [TerrainType.Water, TerrainType.Land], coreFragments: 400, size: ZoidSize.XS, height: 3.0, length: 2.8, speed: 100, type: 'crab', weight: 3.8 },
  crosswinger: { id: 'crosswinger', name: 'Crosswinger', attack: 70, maxHealth: 100, baseExp: 30, scanRate: 70, price: 5000, faction: Faction.HelicRepublic, levelType: LevelType.Fast, terrainTypes: [TerrainType.Air], coreFragments: 800, size: ZoidSize.XS, height: 1.5, length: 5.9, speed: 1111, type: 'dragonfly', weight: 2.5 },
  ...
  elephantus: { id: 'elephantus', name: 'Elephantus', attack: 100, maxHealth: 200, baseExp: 80, scanRate: 30, price: 20000, faction: Faction.HelicRepublic, levelType: LevelType.MediumSlow, terrainTypes: [TerrainType.Land], coreFragments: 2000, size: ZoidSize.M, evolution: new HealthEvolution('mammoth', 1000), height: 4, length: 8.3, speed: 95, type: 'elephant', weight: 17.7, width: 5.1 },
  furolesios: { id: 'furolesios', name: 'Furolesios', attack: 200, maxHealth: 250, baseExp: 80, scanRate: -1, price: 15000, faction: Faction.HelicRepublic, levelType: LevelType.MediumFast, terrainTypes: [TerrainType.Water, TerrainType.Land], coreFragments: 1600, size: ZoidSize.M, height: 4.5, length: 12.4, speed: 65, type: 'amphibian', weight: 28.5, width: 7.2 },
  ...
  godos: { id: 'godos', name: 'Godos', attack: 120, maxHealth: 250, baseExp: 60, scanRate: -1, price: 8000, faction: Faction.HelicRepublic, levelType: LevelType.MediumFast, terrainTypes: [TerrainType.Land], coreFragments: 1200, size: ZoidSize.S, height: 8.6, length: 8.2, speed: 150, type: 'dinosaur', weight: 23, width: 4.6 },
  geruder: { id: 'geruder', name: 'Geruder', attack: 160, maxHealth: 450, baseExp: 50, scanRate: 30, price: 30000, faction: Faction.ZenebasEmpire, levelType: LevelType.Fluctuating, terrainTypes: [TerrainType.Land], coreFragments: 1400, size: ZoidSize.M, height: 4.5, length: 10.73, speed: 200, type: 'dinosaur', weight: 25 },
  giraffsworder: { id: 'giraffsworder', name: 'Girafsworder', attack: 160, maxHealth: 150, baseExp: 35, scanRate: 45, price: 5000, faction: Faction.Neutral, levelType: LevelType.Fast, terrainTypes: [TerrainType.Land], coreFragments: 800, size: ZoidSize.XS, height: 3.6, length: 9.2, speed: 320, type: 'stag_beetle', weight: 8.2 },
  ...
  goliath: { id: 'goliath', name: 'Goliath', attack: 10, maxHealth: 450, baseExp: 60, scanRate: 80, price: 6000, faction: Faction.GuylosEmpire, levelType: LevelType.MediumFast, terrainTypes: [TerrainType.Land], coreFragments: 1000, size: ZoidSize.XS, height: 2.9, length: 3.1, speed: 120, type: 'snail', weight: 5 },
  ...
  gordos: { id: 'gordos', name: 'Gordos', attack: 280, maxHealth: 1200, baseExp: 150, scanRate: -1, price: 120000, faction: Faction.HelicRepublic, levelType: LevelType.Slow, terrainTypes: [TerrainType.Land], coreFragments: 2500, size: ZoidSize.L, height: 12.1, length: 25.5, speed: 80, type: 'stegosaurus', weight: 199, width: 8 },
  grandmolar: { id: 'grandmolar', name: 'Grandmolar', attack: 120, maxHealth: 400, baseExp: 50, scanRate: 40, price: 20000, faction: Faction.GuylosEmpire, levelType: LevelType.MediumSlow, terrainTypes: [TerrainType.Land], coreFragments: 1000, size: ZoidSize.XS, height: 1.4, length: 4.6, speed: 90, type: 'mole', weight: 6.8 },
  gunbeetle: { id: 'gunbeetle', name: 'Gunbeetle', attack: 120, maxHealth: 200, baseExp: 35, scanRate: 45, price: 5000, faction: Faction.Neutral, levelType: LevelType.Fast, terrainTypes: [TerrainType.Land], coreFragments: 800, size: ZoidSize.XS, height: 3.5, length: 8.6, speed: 350, type: 'beetle', weight: 8 },
  ...
  helldiver: { id: 'helldiver', name: 'Helldiver', attack: 170, maxHealth: 90, baseExp: 20, scanRate: 70, price: 3000, faction: Faction.ZenebasEmpire, levelType: LevelType.Fast, terrainTypes: [TerrainType.Water], coreFragments: 600, size: ZoidSize.XS, height: 2, length: 6.6, speed: 148, type: 'hammerhead_shark', weight: 2.9 },
  ...
  hyperscissors: { id: 'hyperscissors', name: 'Hyperscissors', attack: 40, maxHealth: 150, baseExp: 20, scanRate: 75, price: 2000, faction: Faction.HelicRepublic, levelType: LevelType.Fast, terrainTypes: [TerrainType.Water, TerrainType.Land], coreFragments: 400, size: ZoidSize.XS, height: 1, length: 5.8, speed: 90, type: 'crayfish', weight: 3.8 },
  ...
  mammoth: { id: 'mammoth', name: 'Mammoth', attack: 250, maxHealth: 800, baseExp: 120, scanRate: -1, price: 100000, faction: Faction.HelicRepublic, levelType: LevelType.Slow, terrainTypes: [TerrainType.Land], coreFragments: 2500, size: ZoidSize.XL, height: 14.2, length: 19.6, speed: 90, type: 'mammoth', weight: 145, width: 10.8 },
  ...
  pegasuros: { id: 'pegasuros', name: 'Pegasuros', attack: 180, maxHealth: 120, baseExp: 70, scanRate: -1, price: 15000, faction: Faction.HelicRepublic, levelType: LevelType.MediumSlow, terrainTypes: [TerrainType.Air, TerrainType.Land], coreFragments: 1600, size: ZoidSize.S, height: 4.8, length: 7.9, speed: 5800, type: 'bird', weight: 6.2, width: 8.4 },
  ...
  saradin: { id: 'saradin', name: 'Saradin', attack: 60, maxHealth: 500, baseExp: 50, scanRate: 60, price: 10000, faction: Faction.HelicRepublic, levelType: LevelType.MediumSlow, terrainTypes: [TerrainType.Land], coreFragments: 1000, size: ZoidSize.XS, height: 1.8, length: 5.5, speed: 120, type: 'armadillo', weight: 6.5 },
  sea_batoras: { id: 'sea_batoras', name: 'Sea Batoras', attack: 50, maxHealth: 180, baseExp: 20, scanRate: 70, price: 2500, faction: Faction.HelicRepublic, levelType: LevelType.Fast, terrainTypes: [TerrainType.Water], coreFragments: 400, size: ZoidSize.XS, height: 0.9, length: 4.5, speed: 750, type: 'horseshoe_crab', weight: 4.9 },
