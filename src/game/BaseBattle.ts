...
import { calculateClickAttack, type PlayerStats } from '../models/Player';
import { getZoidById, type ZoidInstance } from '../models/Zoid';
import {
  damageEvents,
  type DamageSource,
  setDamageEvents,
...
export abstract class BaseBattle {
  ...
  clickAttack(): void {
    ...
    const damage = calculateClickAttack(this.playerStats);
