...
export const CITIES: City[] = [
  ...
  },
  {
    actions: [
      ...
      // Segment 2 Helic: Abandoned Camp briefing
      new ActionTalkToNPC('abandoned_camp_officer',
        [new MissionCompletedRequirement(O, 'companions_pre_ruins')],
        [new MissionCompletedRequirement(O, 'head_to_ruins')]),
      // Segment 2 Helic: Head to ruins (cutscene: mercenary ambush)
      new ActionPlayCutscene(CUTSCENES.narration_mercenary_ambush, 'ui:head_to_ruins',
        [new MissionCompletedRequirement(O, 'visit_abandoned_camp')],
        [new MissionCompletedRequirement(O, 'head_to_ruins')],
        missionAdvanceReward(O)),
      // Segment 2 Helic: Fight mercenaries
      new ActionFightPilot(PILOTS['mercenaries'],
        [new MissionCompletedRequirement(O, 'head_to_ruins')],
        [new PilotDefeatRequirement('mercenaries')]),
      // Segment 2 Helic: Fight Sea Panther
      new ActionFightPilot(PILOTS['mercenary_leader'],
        [new MissionCompletedRequirement(O, 'fight_mercenaries')],
        [new PilotDefeatRequirement('mercenary_leader')]),
    ],
  ...
  },
  {
    actions: [
      ...
      new ActionTalkToNPC('training_officer',
        ...
        undefined,
        'ui:receive_orders'),
      // Segment 2: Pre-ruins companion dialogs
      new ActionTalkToNPC('kara',
        [new MissionCompletedRequirement(O, 'ruins_briefing')],
        [new MissionCompletedRequirement(O, 'visit_abandoned_camp')]),
      new ActionTalkToNPC('cynian_rain',
        [new MissionCompletedRequirement(O, 'ruins_briefing')],
        [new MissionCompletedRequirement(O, 'visit_abandoned_camp')]),
      ...
      // Segment 2: Ruins debrief
      new ActionTalkToNPC('training_officer',
        [new MissionCompletedRequirement(O, 'escape_ruins')],
        [new MissionCompletedRequirement(O, 'reconciliation')]),
      // Segment 2: Reconciliation
      new ActionTalkToNPC('kara',
        [new MissionCompletedRequirement(O, 'ruins_debrief')],
        [new MissionCompletedRequirement(O, 'reconciliation')],
        missionAdvanceReward(O)),
      new ActionVisitDepot([ITEMS.core_preserver as ConsumableItem, ITEMS.core_saver as ConsumableItem], undefined, 'ui:visit_armory'),
      new ActionVisitLab('lab'),
