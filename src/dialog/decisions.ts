...
import { setPlayerFaction, setPlayerRank } from '../store/gameStore';
...
export const DECISIONS: Record<string, DialogDecision> = {
  arthur_join_republic: new DialogDecision(
    ...
    [
      new DialogChoice('ui:accept', DialogScript.fromKeys('pilots:arthur', 'dialog:arthur_accept', 'images/pilots/arthur.png'), undefined, () => { setPlayerFaction(Faction.HelicRepublic); setPlayerRank(Rank.Recruit, Faction.HelicRepublic); startCampaign('olympus_threat'); }),
  ...
  concho_join_guylos: new DialogDecision(
    ...
    [
      new DialogChoice('ui:accept', DialogScript.fromKeys('pilots:concho_cancer', 'dialog:concho_accept', 'images/pilots/concho.png'), undefined, () => { setPlayerFaction(Faction.GuylosEmpire); setPlayerRank(Rank.Recruit, Faction.GuylosEmpire); startCampaign('olympus_guylos'); }),
