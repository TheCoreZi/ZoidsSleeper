...
export const REGIONS: Region[] = [
  {
    cityIds: ['abandoned_camp', 'arcobaleno_camp', 'chimera_island', 'gleam_village', 'porto_nido', 'wind_colony', 'wind_oasis'],
    ...
    routeIds: ['bandit_trail', 'conservation_archipelago', 'dustwind_trail', 'elmia_desert', 'gleam_outskirts', 'sommerso_trail', 'south_coast', 'tauros_edge', 'wind_road'],
