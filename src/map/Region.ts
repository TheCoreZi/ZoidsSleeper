...
export const REGIONS: Region[] = [
  {
    ...
    dungeonIds: ['hollow_ruins', 'elmia_ruins', 'sommerso_ruins', 'tauros_grotto'],
    id: 'south_europa',
    image: 'images/map/south_europa.png',
    imageSize: { h: 1024, w: 1536 },
    initialLandmark: 'gleam_village',
    name: 'Southern Europa',
    routeIds: ['bandit_trail', 'conservation_archipelago', 'dustwind_trail', 'elmia_desert', 'gleam_outskirts', 'gorge_approach', 'gorge_trail', 'imperial_trail', 'republican_trail', 'ruins_path', 'sommerso_trail', 'south_coast', 'tauros_edge', 'wind_road'],
